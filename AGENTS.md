...
* Documentation structure and content standards live in `docs/AGENTS.md`. All documentation prose follows ASD-STE100 Simplified Technical English per the writing standard in `docs/AGENTS.md`.
