...
- **Binary Compatibility:** Breaking API changes are a MAJOR version bump per `docs/dev/CONVENTIONS-COMMITS.md` (`!` or `BREAKING CHANGE` footer).
...
* `./gradlew :skilling-api:build` — compiles module, generates javadoc and sources jars.
