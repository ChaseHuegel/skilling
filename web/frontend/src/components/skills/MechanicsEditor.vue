...
const FALLBACK_MECHANICS = [
  ...
  'core:offhand_strike', 'core:offhand_swing', 'core:damage', 'core:true_damage',
  'core:set_cooldown', 'core:modify_attack_speed', 'core:dodge',
...
const FALLBACK_PARAM_NAMES: Record<string, string[]> = {
  ...
  'core:offhand_swing': [],
  'core:damage': ['damage', 'percent'],
  'core:true_damage': ['damage', 'percent'],
  ...
  'core:modify_brew_output': ['chance'],
