...
- [x] Deliver the full report as `docs/reports/REPORT_XP-CURVE.md`

## Technical Specifications & Context

- **Target Files:**
  - `docs/reports/REPORT_XP-CURVE.md` (deliverable)
...
- [x] `docs/reports/REPORT_XP-CURVE.md` exists and documents the methodology (assumptions, rates, hours-per-level math)
