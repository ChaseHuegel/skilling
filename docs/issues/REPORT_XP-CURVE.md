...
differ enormously, producing a **21.5× spread** in estimated focused time-to-100 — from
**~390 hours** (riding) to **~8,300 hours** (alchemy), with a median near **~1,070 hours**.
...
The curve is a late-weighted power curve: the final 10 levels (90→100) demand
...
### 2.2 Reward behavior modelled (current code)
...
conclusion about the spread (the ratios between skills are robust to the shared APM
...
*eating*, or low-frequency events (totem, jukebox) is **3,000–8,300 h** — beyond any
...
- XP to level 99 is **13,034,431**; **level 92 is exactly half** of 99's total — a curve
